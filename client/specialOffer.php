...
$sql = "SELECT * FROM produit WHERE nouveau_prix <= (0.7 * ancien_prix)";
...
<body>
   ...
   <div class="pubHaut"><img src="../images/pub.gif" alt="pubHaut"></div>
   <section class="contentSpecial">
            
      <div class="pub pub1">
         <img src="../images/pub2.gif" alt="pub2">
      </div>
