...
session_start();
   ...
   if(isset($_GET['search_text'])){
      $search = filter_var($_GET['search_text'] , FILTER_SANITIZE_STRING);
      if($search){
         include "../db_connection/db_conn.php";
         $sql = "SELECT * FROM produit WHERE nom_produit LIKE '%$search%' OR libelle_produit LIKE '%$search%'";
...
<body>
   ...
   <h1 class="title">YOUR SEARCH RESULT</h1>
   <section id="popular" class="popular">
      <div class="box">
         ...
         <div class="produit">
            ...
            <form action="buy_product_page.php" method="GET"><button name="id_product" value="<?php echo $row['id_produit'] ?>">Add to cart</button></form>
         </div>
         <?php } ?>
         <?php
            if($size == 0){
         ?>
         <p class="notFound">No Result Found !!</p>
         <?php } ?>
