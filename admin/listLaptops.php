...
session_start();
   ...
   if($_SESSION['username'] && $_SESSION['nom'] && $_SESSION['prenom']){
      ...
      $sql = "SELECT * FROM produit WHERE categorie = 'laptop'";
...
<body>
   ...
   <nav>
      ...
      <div>
         <a href="addLaptopForm.php" class="Ajouter">Add</a>
   ...
   <section class="content" id="bodyContainer">
      ...
      <table>
         <tr><th colspan="9">Laptops List</th></tr>
         <tr>
            <th>Image</th>
            <th>Product</th>
            <th>Description</th>
         ...
         <tr>
            ...
            <td><?php echo $row['nbr_ventes'] ?></td>
             <td><form style="margin: 0;" action="modifyLaptopForm.php" method="POST"><button type="submit" name='id' value="<?php echo $row['id_produit'] ?>" class="Modify">Modify</button></form></td>
